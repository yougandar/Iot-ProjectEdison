...
using Edison.Simulators.Sensors.Input.Helpers;
using CsvHelper;
using System.IO;
...
namespace Edison.Simulators.Sensors.Input
{
    public class Application
    {
        ...
        public async Task RemoveEventClusters()
        {
            ...
            await _repoSagas.DeleteItemsAsync(p => p.CreationDate != DateTime.MinValue);
